...
- (void)getToken {
    ...
    NSString *httpBody
    = [NSString stringWithFormat:@"userId=%@&name=%@&portraitUri=%@", [NSString stringWithFormat:@"s%i",student.student_id], student.student_name, nil];
